...
app.layout = html.Div([
    html.Div([
        ...
        html.P("Real-time meme tracker · Top-10 · Free 3 memes",
               style={'color':'#00D4FF','fontSize':'26px','margin':'10px 0'}),
    ], style={'textAlign':'center','padding':'40px','background':'linear-gradient(135deg,#000,#111)',
              'borderRadius':'25px','boxShadow':'0 15px 50px rgba(0,212,255,0.4)'}),

    html.Div([
        html.Button("FREE 3 MEMES (no card)", id="free",
                    style={'background':'#00FF9D','color':'black','padding':'20px 80px','fontSize':'28px',
                           'fontWeight':'bold','border':'none','borderRadius':'20px','margin':'20px'}),
        html.A("Premium $9/month →",
               ...
               target="_blank",
               style={'background':'#00D4FF','color':'white','padding':'20px 80px','fontSize':'28px',
                      'fontWeight':'bold','textDecoration':'none','borderRadius':'20px','margin':'20px',
    ...
    ], style={'background':'#000','padding':'40px','borderRadius':'25px','margin':'30px',
